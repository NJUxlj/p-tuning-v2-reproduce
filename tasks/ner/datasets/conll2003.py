...
a part-of-speech (POS) tag, the third a syntactic chunk tag and the fourth the named entity tag. 
            ...
            features = datasets.Features(
                {
                    ...
                    "tokens": datasets.Sequence(datasets.Value("string")), # Sequence：用于定义序列类型特征, Sequence 的 length=-1 表示序列长度不固定，id=None 表示这些特征没有额外的标识符
                    "pos_tags": datasets.Sequence( # part of speech
